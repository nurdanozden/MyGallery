...
/**
 * ESERLER
 * `file` alanındaki isimle bir görseli `src/assets/photos/` klasörüne bırakınca
 * otomatik olarak duvara asılır. Görsel yoksa yerine üretilmiş bir yer tutucu gelir.
 */
